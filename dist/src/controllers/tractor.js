    ...
    try {
        const tractor = await prisma.tractor.update({
            ...
            data: {
                ...
                typeOfFuel: req.body.typeOfFuel,
                fuelCapacity: req.body.fuelCapacity,
                purchasePriceNoGST: req.body.purchasePriceNoGST !== undefined
                    ? Number(req.body.purchasePriceNoGST)
                    : undefined,
                purchasePriceTaxable: req.body.purchasePriceTaxable !== undefined
...
export const toggleTractorStatus = async (req, res) => {
    try {
