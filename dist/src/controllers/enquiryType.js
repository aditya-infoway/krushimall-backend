...
export const createEnquiryType = async (req, res) => {
    try {
...
export const getEnquiryTypes = async (req, res) => {
    try {
...
export const getEnquiryTypeById = async (req, res) => {
    try {
...
export const updateEnquiryType = async (req, res) => {
    try {
...
export const deleteEnquiryType = async (req, res) => {
    try {
...
export const toggleEnquiryTypeStatus = async (req, res) => {
    try {
