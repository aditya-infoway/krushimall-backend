...
// Create
export const createUsedWebsiteVariant = async (req, res) => {
    try {
...
// List
export const getUsedWebsiteVariants = async (req, res) => {
    try {
        const vendorAuth = req.vendor;
        const vendor = await prisma.webVendor.findUnique({
            where: {
...
// Get By Id
export const getUsedWebsiteVariantById = async (req, res) => {
    try {
        const vendorAuth = req.vendor;
        const vendor = await prisma.webVendor.findUnique({
            where: {
...
export const getPublicUsedWebsiteVariantById = async (req, res) => {
    try {
...
// Update
export const updateUsedWebsiteVariant = async (req, res) => {
    try {
        const vendorAuth = req.vendor;
        const vendor = await prisma.webVendor.findUnique({
            where: {
...
// Submit
export const submitUsedWebsiteVariant = async (req, res) => {
    try {
        const vendorAuth = req.vendor;
        const vendor = await prisma.webVendor.findUnique({
            where: {
...
// Delete
export const deleteUsedWebsiteVariant = async (req, res) => {
    try {
        const vendorAuth = req.vendor;
        const vendor = await prisma.webVendor.findUnique({
            where: {
...
export const getLatestUsedWebsiteVariants = async (req, res) => {
    try {
        const variants = await prisma.usedWebsiteVariant.findMany({
            where: {
                status: "ACTIVE",
...
export const getPopularUsedWebsiteVariants = async (req, res) => {
    try {
        const variants = await prisma.usedWebsiteVariant.findMany({
            where: {
                status: "ACTIVE",
...
//   }
// };
export const getBestValueUsedWebsiteVariants = async (req, res) => {
    try {
        const variants = await prisma.usedWebsiteVariant.findMany({
            where: {
                status: "ACTIVE",
...
export const getPublicUsedWebsiteVariants = async (req, res) => {
    try {
        const variants = await prisma.usedWebsiteVariant.findMany({
            where: {
                status: "ACTIVE",
