...
export const createEnquirySource = async (req, res) => {
    try {
...
export const getEnquirySourceById = async (req, res) => {
    try {
...
export const updateEnquirySource = async (req, res) => {
    try {
...
export const deleteEnquirySource = async (req, res) => {
    try {
...
export const toggleEnquirySourceStatus = async (req, res) => {
    try {
        ...
        const updated = await prisma.enquirySource.update({
            where: { id },
            data: {
