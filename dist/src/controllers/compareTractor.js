...
// Get Brands
// =========================
export const getCompareBrands = async (req, res) => {
    try {
...
// Get Models By Brand
// =========================
export const getCompareModels = async (req, res) => {
    try {
...
// =========================
export const getCompareVariants = async (req, res) => {
    try {
...
export const getCompareVariantDetails = async (req, res) => {
    try {
...
// =========================
const getTrendingFromModel = async (model, options) => {
    const selectClause = {
        id: true,
        productName: true,
        frontView: true,
    ...
    const getEnquiryCount = (t) => options.enquiryField === "count" ? t._count?.enquiries || 0 : t.enquiryCount || 0;
    const hasEnquiry = tractors.some((t) => getEnquiryCount(t) > 0);
    if (hasEnquiry) {
        tractors = tractors
            .sort((a, b) => getEnquiryCount(b) - getEnquiryCount(a))
            .slice(0, 4);
    }
    else {
...
// =========================
export const getTrendingTractors = async (req, res) => {
    try {
...
// =========================
export const getTrendingUsedTractors = async (req, res) => {
    try {
...
// =========================
export const getCompareUsedVariantDetails = async (req, res) => {
    try {
        const id = Number(req.params.variantId);
...
// =========================
export const getCompareUsedVariants = async (req, res) => {
    try {
        const modelId = Number(req.params.modelId);
...
//# sourceMappingURL=compareTractor.js.map