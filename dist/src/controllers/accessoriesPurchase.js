...
export const getAccessoriesPurchases = async (req, res) => {
    try {
        ...
        const data = purchases.map((purchase) => ({
            ...purchase,
            allItemsInward: purchase.items.length > 0 &&
...
export const getAccessoriesPurchaseById = async (req, res) => {
    try {
        const purchase = await prisma.accessoriesPurchase.findUnique({
            where: {
...
export const verifyAccessoriesPurchase = async (req, res) => {
    try {
...
export const deleteAccessoriesPurchase = async (req, res) => {
    try {
...
export const updateAccessoriesPurchaseItemStatus = async (req, res) => {
    try {
        const { id } = req.params;
