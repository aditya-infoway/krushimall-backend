...
import { createBanker, getBankers, getBankerById, updateBanker, deleteBanker, toggleBankerStatus, } from "../controllers/banker.js";
...
router.patch("/toggle-status/:id", verifyToken, toggleBankerStatus);
