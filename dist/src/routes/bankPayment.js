...
import { getBankPayments, getBankPaymentById, getBankPaymentVoucher, createBankPayment, updateBankPayment, deleteBankPayment, exportBankPaymentExcel } from "../controllers/bankPayment.js";
...
router.get("/export/excel", verifyToken, exportBankPaymentExcel);
