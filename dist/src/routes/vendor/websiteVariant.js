...
router.post("/", verifyVendorToken, mediaUpload, WebsiteVariantController.createWebsiteVariant);
router.get("/", verifyVendorToken, WebsiteVariantController.getWebsiteVariants);
router.get("/:id", verifyVendorToken, WebsiteVariantController.getWebsiteVariantById);
router.put("/:id", verifyVendorToken, upload.any(), WebsiteVariantController.updateWebsiteVariant);
router.put("/:id/save-step", verifyVendorToken, mediaUpload, WebsiteVariantController.saveStep);
router.put("/:id/submit", verifyVendorToken, WebsiteVariantController.submitWebsiteVariant);
router.delete("/:id", verifyVendorToken, WebsiteVariantController.deleteWebsiteVariant);
