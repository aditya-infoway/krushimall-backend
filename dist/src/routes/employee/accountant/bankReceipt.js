...
router.get("/generate-voucher", BankReceiptController.getBankReceiptVoucher);
router.get("/export/excel", verifyEmployeeToken, BankReceiptController.exportBankReceiptExcel);
router.get("/:id/print", verifyEmployeeToken, BankReceiptController.printBankReceipt);
