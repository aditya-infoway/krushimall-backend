...
router.get("/generate-voucher", CashReceiptController.getCashReceiptVoucher);
router.get("/export/excel", verifyEmployeeToken, CashReceiptController.exportCashReceiptExcel);
router.get("/:id/print", verifyEmployeeToken, CashReceiptController.printCashReceipt);
