...
router.get("/pending", verifyEmployeeToken, PurchaseController.getPendingPurchasesForCashPayment);
...
router.put("/purchase-items/:id/inward", verifyEmployeeToken, PurchaseController.submitPurchaseItemInward);
