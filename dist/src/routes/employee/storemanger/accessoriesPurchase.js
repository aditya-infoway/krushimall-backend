...
import { createAccessoriesPurchase, getAccessoriesPurchases, getAccessoriesPurchaseById, updateAccessoriesPurchase, verifyAccessoriesPurchase, deleteAccessoriesPurchase, getAccessoriesPurchaseBillNo, updateAccessoriesPurchaseItemStatus, getAccessoriesInventory, getAccessoryPurchaseHistory, } from "../../../controllers/employee/storemanger/accessoriesPurchase.js";
...
router.get("/history/:accessoryId", verifyEmployeeToken, getAccessoryPurchaseHistory);
router.put("/:id", verifyEmployeeToken, updateAccessoriesPurchase);
router.put("/item-status/:id", verifyEmployeeToken, updateAccessoriesPurchaseItemStatus);
router.put("/verify/:id", verifyEmployeeToken, verifyAccessoriesPurchase);
