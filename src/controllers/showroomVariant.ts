  ...
  try {
    ...
    if (
      ...
      return res.status(400).json({
        success: false,
        message:
          "Model and variant are required",
      });
    }
    ...
    if (existing) {
      return res.status(400).json({
        success: false,
        message:
          "Showroom variant already exists for this model",
      });
    }

    const showroomVariant =
      await prisma.showroomVariant.create({
        data: {
          ...
          purTaxPercent:
            Number(purTaxPercent),

          exShowroomPrice:
            Number(exShowroomPrice),
    ...
    return res.status(201).json({
      ...
      message:
        "Showroom Variant created successfully",
    });
  } catch (error) {
    console.error(
      "CREATE SHOWROOM VARIANT ERROR:",
      error,
    );
    ...
    return res.status(500).json({
      ...
      message:
        "Failed to create showroom variant",
    });
  }
};
...
export const getShowroomVariants = async (
  ...
  try {
    ...
    return res.status(500).json({
      success: false,
      message:
        "Failed to fetch showroom variants",
    });
  }
};
  ...
  async (
    ...
    try {
      ...
      return res.status(500).json({
        success: false,
        message:
          "Failed to fetch showroom variant",
      });
    }
  };
  ...
  async (
    ...
    try {
      ...
      return res.status(500).json({
        ...
        message:
          "Failed to update showroom variant",
      });
    }
  };
  ...
  async (
    ...
    try {
      ...
      return res.status(500).json({
        ...
        message:
          "Failed to delete showroom variant",
      });
    }
  };