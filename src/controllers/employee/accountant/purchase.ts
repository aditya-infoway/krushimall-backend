...
export const submitPurchaseItemInward =
  PurchaseController.submitPurchaseItemInward;
export const getVehicleSerialNo =
  PurchaseController.getVehicleSerialNo;
export const saveTransport = PurchaseController.saveTransport;
export const getTransport = PurchaseController.getTransport;
export const getTractorInventory =
  PurchaseController.getTractorInventory;