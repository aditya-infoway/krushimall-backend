...
export interface DeliveryChallanData {
  ...
  checklist: {
    ...
    rtoReceipt: boolean; // NOTE: abhi Order model me ye field nahi hai, isliye hamesha false rahega
...
const checklistLabels: { key: keyof DeliveryChallanData["checklist"]; label: string }[] = [
...
export function generateDeliveryChallanHtml(data: DeliveryChallanData): string {
