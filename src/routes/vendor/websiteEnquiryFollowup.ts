...
router.get(
  "/enquiry/:enquiryId",
  verifyVendorToken,
  WebsiteEnquiryFollowupController.getFollowupsByEnquiry
);

router.get(
  "/today",
  verifyVendorToken,
  WebsiteEnquiryFollowupController.getTodayFollowups
);
...
router.put(
  "/:id",
  verifyVendorToken,
  WebsiteEnquiryFollowupController.updateFollowup
);
...
router.delete(
  "/:id",
  verifyVendorToken,
  WebsiteEnquiryFollowupController.deleteFollowup
);
